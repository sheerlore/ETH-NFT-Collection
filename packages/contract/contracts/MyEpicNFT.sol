...
contract MyEpicNFT is ERC721URIStorage {
    ...
    uint public constant TOTAL_MINT_COUNT = 50;
    ...
    event NewEpicNFTMinted(address sender, uint256 tokenId, uint currentNum);
    ...
    function makeAnEpicNFT() public {
        require(_tokenIds.current() <= TOTAL_MINT_COUNT, "NFT Limit Error");
        _tokenIds.increment();
